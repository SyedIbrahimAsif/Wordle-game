...
def choose_word():
    ...
    words = ["abbey", "abled", "abler", "abide", "ables", "abuzz", "acorn", "acred", "adage", "adays", "addle", "adieu", "agate", "agaze", "agent", "agger", "agile", "aging", "aglow", "agone", "agree", "alamo", "alate", "alway", "amole", "ample", "anglo", "angus", "anise", "antra", "anted", "anyon", "apage", "apian", "apnea", "apple", "aquas", "arcus", "argan", "argil", "argue", "arise", "armor", "armed", "artel", "ascot", "asper", "asset", "attest", "audio", "audit", "auger", "aural", "avian", "avise", "axoid", "azote", "bacon", "badge", "bafta", "bager", "baggy", "banal", "baron", "baser", "basky", "batch", "begot", "betas", "bible", "bilge", "bison", "biped", "blank", "blitz", "block", "blurb", "blush", "booby", "boose", "bourn", "boxer", "bower", "boxey", "boyar", "brace", "brash", "brave", "brose", "bumpy", "butte", "cabin", "cabal", "cache", "cadet", "camel", "carol", "casus", "chads", "chape", "chaos", "chock", "chive", "chock", "chlor", "claps", "clamp", "clear", "cluck", "crack", "cuban", "cuter",  "damps","dears", "depth", "dingo", "doner", "dodge", "dolce", "downy", "dwarf", "edgey", "elder", "elect", "elide", "enema", "escar", "exile", "faxed", "feuar", "fezes", "feyer", "ficus", "fiber", "frisk", "funny", "fudge", "gazed", "gemmy", "geese", "gered", "gilt", "girly", "gothic", "greet", "haunt", "hecto", "horse", "house", "hoist", "hotly", "icyly", "idol", "idyll", "invoy", "jabby", "jolly", "jiffy", "jumbo", "kayak", "keyer", "large", "lapse", "leper", "lucky", "lupus", "madly", "maked", "malth", "manly", "merry", "mighty", "motif", "nacho", "noddy",  "ounce",  "ouija", "pacey", "panky", "prick", "quail", "quote", "quoth", "reach", "ready", "robin", "rompy", "soily", "squash", "search","smush", "smite", "slick", "snoop", "snuck", "stags", "stake", "stria", "sweet", "taint", "teary", "topic", "trophy", "uncle", "unlit", "unraw", "vessel", "venom", "vices", "viewy", "yages", "yucky"]
